...
try:
    ...
    ARTICLE_LIMIT = KNOWLEDGE_BASE_BUILDER_CONFIG.get("article_limit_per_section", 30)
except (ImportError, AttributeError):
    ARTICLE_LIMIT = 30  # Значение по умолчанию

ARTICLE_URLS = get_relevant_article_urls(limit_per_section=ARTICLE_LIMIT)
